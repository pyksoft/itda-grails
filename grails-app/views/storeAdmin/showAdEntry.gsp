...
<html>
    <head>
        ...
        <title>Show Ad Collection Entry</title>
    </head>
    <body>
        ...
        <div class="body">
            <h1>Show Ad Collection Entry</h1>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: portfolioEntryInstance.portfolio, field: "description")}</td>
...
<%--
 ...
 --%>                   
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="portfolioEntry.adPageNumber.label" default="Ad Number" /></td>
...
<%-- focus --%>
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <g:hiddenField name="collectionId" value="${portfolioEntryInstance?.portfolio?.id}" />
                    <span class="button"><g:actionSubmit class="edit" action="editAdEntry" value='Edit' /></span>
                    <span class="button"><g:actionSubmit class="delete" action="deleteAdEntry" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
                </g:form>
            </div>
        </div>
    </body>
