...
<script type="text/javascript">
	window.onload =function() {
	 uploader = new plupload.Uploader({
		...
		container : 'container',
		max_file_size : '30mb',
		url : "/portfolioEntry/uploadJpg?portfolioId=${params.portfolioId}",
    ...
    <div id="content">
       	<form id="form1" action="/portfolioEntry/uploadJpg.gsp" method="post" enctype="multipart/form-data">
			<table><tr>
				<td>
