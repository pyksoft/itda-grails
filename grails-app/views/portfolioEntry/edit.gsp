...
<html>
    ...
    <body>
        ...
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="create" action="create" params='[portfolioId:params.portfolioId]'><g:message code="default.new.label" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
                        ...
                        <tr class="prop">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: portfolioEntryInstance, field: 'adTabNumber', 'errors')}">
                                    <g:select name="adTabNumber" noSelection="${['':'Select One...']}" from="${[1,2,3]}" value="${portfolioEntryInstance?.adTabNumber}"/>
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
