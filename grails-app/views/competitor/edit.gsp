    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${competitorInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="businessName"><g:message code="competitor.businessName.label" default="Competitor Business Name" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: competitorInstance, field: 'business', 'errors')}">
                                    ...
                                    <option value="${competitorInstance?.business?.id}" >
                                    ${competitorInstance?.business?.businessName}</option></select>
               </td>
                            </tr>
