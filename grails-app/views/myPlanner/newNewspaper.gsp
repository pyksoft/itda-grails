                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td colspan="2" class="value " valign="top">
                                    ...
                                    <input size="35" maxlength="128" id="contactName" name="contactName" type="text">
                                </td>
                            </tr> 
                            <tr class="prop">
                                <td colspan="2" class="value " valign="top">
                                    ...
                                    <input size="35" maxlength="12" id="contactPhone" name="contactPhone" type="text">
                                </td>
                            </tr> 
                            <tr class="prop">
                                <td colspan="2" class="value " valign="top">
                                    <span class="red">*</span> Email:<br>
                                    <input size="35" id="email" name="email" type="text">
                                </td>
                            </tr> 
                            <tr class="prop">
