...
<html>
    <head>
        ...
        <title>Upload Spine Image</title>
...
window.onload =function() {
	 uploader = new plupload.Uploader({
		...
		container : 'container',
		max_file_size : '300mb',
		url : "/portfolio/uploadSpineImage/${params.id}",
    ...
    <div id="content">
       	<form id="form1" action="/portfolio/uploadSpineImage" method="post" enctype="multipart/form-data">
                <div class="dialog">
                    <table>
                        <tbody>
