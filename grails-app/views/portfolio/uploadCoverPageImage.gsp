...
window.onload =function() {
	 uploader = new plupload.Uploader({
		...
		container : 'container',
		max_file_size : '300mb',
		url : "/portfolio/uploadCoverPageImage/${params.id}",
    ...
    <body style="background:none repeat scroll 0 0 #FFFFFF; border:1px solid #475659; color:#333333; font:15px verdana,arial,helvetica,sans-serif; margin:auto; text-align:center; width:1024px;">    
        ...
        <div class="body">
            <h1>Upload Portfolio Cover Page</h1>
    ...
    <div id="content">
       	<form id="form1" action="/portfolio/uploadCoverPageImage" method="post" enctype="multipart/form-data">
                <div class="dialog">
                    <table>
                        <tbody>
