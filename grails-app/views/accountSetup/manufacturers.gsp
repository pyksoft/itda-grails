...
<script type="text/javascript" 	src="/jquery/js/jquery-ui-1.8.7.custom.min.js"></script>
	...
	$(document).ready(function() {
		...
		$('body.myAcct div#tabs.ui-tabs ul.ui-tabs-nav li a[href="#tabs-4"]').parent().addClass('last-tab');
	   	if($.cookie('accountManufacturerPopup') == '1') {
			var title = 'Enter the information<br/>for your Manufacturers<br/>here.';
			var desc = 'Their contact information will<br/>be just a click away.';
			openAcctInfoDialog(title, desc);
    		$.cookie('accountManufacturerPopup', null, { expires: 0, path: '/accountSetup/manufacturers'});
    		$.getJSON('/myAccount/updateSettings?accountManufacturerPopup=1', {}, function(data) {});
    	}				
	});
	</script>    
...
<div id="canvas" width="992px">
	...
	<div class="line" id="line1">	  	
	  ...
	  <div class="item" id="item2">
	  	...
	  	<a href='/accountSetup/manufacturers' class='acct-link-active'>Manufacturers</a><br/>
	  	</p>
	  	</div>
	  </div>
	  	...
	  	<div class="sap-content">
  			<div id="tabs" class='page-bg'>
				...
				<div id="tabs-4">
		            ...
		            <tr><td >
						<g:include view="accountSetup/listManufacturerTabFrag2.gsp"/>	 
						<g:submitButton name="addManu" value="" class="acct-add-manu-button my-acct" style="float:right" onclick="myAcctDialog(); return false"/><br/>

						<div style="clear:both"></div>
						<div class='paginateButtons' style="float:right">
							<g:paginate controller="accountSetup" action="manufacturers" total="${manufacturerInstanceList.totalCount}"></g:paginate>
						</div>  
		            </td></tr>
					</table>				</div>
			</div>	  	
	  ...
	  <div id="dialog-my-acct" title="" style="font-size: 13; display: none; text-align:left;z-index:100000; overflow:hidden; min-height:550px; width:280px">
            <div id="errorList" class="errors" style="display: none;"></div>	
				<table width="100%" class='acct-content'>
					<tr>
						<td>
						<h2><span id="action">Who are your Manufacturers?</span> </h2>
						</td>
					</tr>
					<tr><td>	  		
	  		     		<g:include view="accountSetup/manufacturer-new.gsp"/>
	  		     		</td>
					</tr>
					<tr>
						<td style='vertical-align:bottom; padding: 10px 10px 0 0'>	  		
							<input class="acct-add-button my-acct" type="submit" onclick="saveAccountRelationship('/accountSetup/saveManufacturer', '/accountSetup/manufacturers', '#acctInfoForm', '#errorList'); return false;" value="" name="add-btn" style="float:right;margin-left:10px">
							<input class="acct-update-button" type="submit" onclick="saveAccountRelationship('/accountSetup/updateManufacturer', '${request.getRequestURL()}', '#acctInfoForm', '#errorList'); return false;" value="" name="update-btn" style="float:right;margin-left:10px">
