(function(a){a.fn.listselect=function(c){c=a.extend({size:10,listTitle:"All",selectedTitle:"Selected"},c);return this.each(function(){var d=a('<div style="margin-right: 5px; float: left; width: 105px;"></div>');c.listTitle&&c.listTitle!=""&&d.append("<strong>"+c.listTitle+"</strong>");var f=a('<div style="float: left; width: 105px;"></div>');c.selectedTitle&&c.selectedTitle!=""&&f.append("<strong>"+c.selectedTitle+"</strong>");var b=a(this);d.insertBefore(b);f.insertAfter(d);b.remove();var i=a('<div style="clear: both;"></div>');
